...
$FMT_OBJ_CMD
#
MAIN_OBJ_CMD="g++-11  -fopenmp -I include/ -I $SQLITE_DIR -I $FMT_DIR/include/ src/main.cpp -c -o src/main.o"
echo "$MAIN_OBJ_CMD"
$MAIN_OBJ_CMD
#
PAR_FAAI_BUILD="g++-11  -fopenmp -I $SQLITE_DIR $SQLITE_DIR/sqlite3.o $FMT_DIR/src/format.o src/main.o -ldl -o main.exe"
echo "$PAR_FAAI_BUILD"
$PAR_FAAI_BUILD
